...
if(isset($_SESSION['rola']) && $_SESSION['rola'] == 0){
	...
	if(isset($_POST['izmeni'])){
		if((!$_POST['sifra']) || ($_POST["bool"] != 0 && $_POST["bool"] != 1) || (!$_POST['boja']) || (!$_POST['cena']) || (!$_POST['fajl'])){
			echo "<script>alert(\"Morate uneti sve podatke!\")</script>";
		}
		else{
			$sifraArtikla = $_POST['sifra'];
			...
			$upit1 = "update artikal set SoljaMajica = '$soljaMajica', Boja = '$boja', Cena = '$cena', Fajl = '$fajl'
			...
			if(!$rez1){
				...
				$_SESSION['poruka'] = "<script>alert('Uspešno izmenjen artikal!')</script>";
				header("Location: pregledSvihArtikala.php");
			}             
		}

		$sifraArtikla = $_POST['sifra'];
		$soljaMajica = $_POST['bool'];
		$boja = $_POST['boja'];
		$cena = $_POST['cena'];
		$fajl = $_POST['fajl'];
	}
...
<form class="logIn" method="post">
	<div class="container">
		<h1>Izmenite artikal</h1>
		<div class="levo">

			<div class="form-group">
				<label for="sifra">Šifra artikla</label>
				<input type="text" class="form-control" id="sifra" name="sifra" readonly="true" value="<?php echo $sifraArtikla ?>">
			</div>
			<div class="form-group">
				<label for="boja">Boja</label>
				<input type="text" class="form-control" id="boja" name="boja" value="<?php echo $boja ?>">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="fajl" name="fajl" value="<?php echo $fajl ?>">
			</div>
		</div>
